...
Using the KEM encapsulation algorihtm `KEM.Encapsulation`, and the long-term input material `kem.pk_R` of the Responder, the Initiator generated the couple `(ss_R, kem.ct_R)`.
